    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://203.170.69.170:8070/api/INVAPI/MRNList?type=E`,
          {
            headers: {
        ...
        const MRNListElectrical = await response.data;

        setData(MRNListElectrical);
        setIsLoading(false);
      } catch (error) {
        console.error(error);
      }
